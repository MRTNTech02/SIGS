        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                echo "<script>
                    ...
                    window.location.href = 'registrar_profile.php';
                </script>";
                exit();
            } else {
    ...
    <div class="d-flex">
        ...
        <div class="content p-4">
            ...
            <div class="d-flex justify-content-start mb-3">
                <a href="registrar_profile.php" class="btn btn-success me-2">Information</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="registrar_profile.php" method="post">
